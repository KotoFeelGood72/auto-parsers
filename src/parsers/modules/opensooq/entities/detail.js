    ...
    async parseCarDetails(url, context) {
        ...
        try {
                ...
                return Array.from(
                    new Set(
                        images
                            ...
                            .filter(src => src && (src.includes("opensooq.com") || src.includes("cloudfront.net")))
                    )
                );
            ...
            const carDetails = {
                ...
                year,
                body_type: bodyType,
                horsepower: "Не указано", // OpenSooq обычно не показывает мощность
                fuel_type: fuelType,
