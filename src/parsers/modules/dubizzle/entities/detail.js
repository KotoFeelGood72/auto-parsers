...
class DubizzleDetailParser {
    constructor(config) {
        ...
        this.selectors = {
            // Основные данные
            title: '[data-testid="ad-title"]',
            price: '[data-testid="ad-price"]',
            location: '[data-testid="ad-location"]',
            
            // Детали автомобиля
            make: '[data-testid="ad-make"]',
            model: '[data-testid="ad-model"]',
            year: '[data-testid="ad-year"]',
            bodyType: '[data-testid="ad-body-type"]',
            fuelType: '[data-testid="ad-fuel-type"]',
            transmission: '[data-testid="ad-transmission"]',
            mileage: '[data-testid="ad-mileage"]',
            color: '[data-testid="ad-color"]',
            
            // Продавец
            sellerName: '[data-testid="seller-name"]',
            sellerType: '[data-testid="seller-type"]',
            phone: '[data-testid="seller-phone"]',
            
            // Изображения
            images: '[data-testid="ad-image"] img',
            mainImage: '[data-testid="ad-main-image"]'
        };
    ...
    async parseCarDetails(url, context) {
        ...
        try {
                ...
                return Array.from(
                    new Set(
                        images
                            ...
                            .filter(src => src && (src.includes("dubizzle.com") || src.includes("cloudfront.net")))
                    )
                );
            ...
            const carDetails = {
                ...
                year,
                body_type: bodyType,
                horsepower: "Не указано", // Dubizzle обычно не показывает мощность
                fuel_type: fuelType,
